...
com.init = function (stype){
	...
	com.width			=	stype.width;		//Chiều rộng canvas
	com.height			=	stype.height; 		//Chiều cao canvas
	com.spaceX			=	stype.spaceX;	    //Khoảng tác động X
	com.spaceY			=	stype.spaceY;		//Nhịp y
	com.pointStartX		=	stype.pointStartX;	//Tọa độ X của điểm đầu tiên
	com.pointStartY		=	stype.pointStartY;	//Tọa độ y của điểm đầu tiên
	com.page			=	stype.page;          //thư mục ảnh
	
	com.get("box").style.width = com.width+130+"px";
	
	com.canvas			=	document.getElementById("chess"); //Vẽ canvas
	...
	com.loadImages(com.page);	//load ảnh lên
	////z(com.initMap.join())	
}
com.stype = {
	stype1:{
...
window.onload = function(){  
	...
	com.get("tyroPlay").addEventListener("click", function(e) {
		if (confirm("Xác nhận để bắt đầu trò chơi?")){
			play.isPlay=true ;	
			play.depth = 3;
			play.init();
		}
...
//Viết tắt của com.alert, vì tên biến z ít được sử dụng nhất
var z = com.alert;
...
//Quân đen là sự đảo ngược giá trị của quân đỏ
...
com.args={
	//cờ / Địa chỉ hình ảnh / Faction / Trọng lượng
